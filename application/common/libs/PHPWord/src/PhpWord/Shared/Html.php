...
//        echo "<pre>";print_r($cellStyles);
    ...
    protected static function parseList($node, $element, &$styles, &$data)
    {
        ...
        if (isset($data['listdepth'])) {
            ...
            /**
             * neu ul nam trong td mac dinh listStyle = 0 de ko format khac kieu BULLET
            */
            if ($node->parentNode->nodeName == 'td' && $node->nodeName == 'ul') {
                $styles['list'] = 'listStyle_0';
            }
