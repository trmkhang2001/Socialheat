...
<style>
	...
	.list_keyword_social li:hover, .post_keywords i:hover {
		color: #000000 !important;
	}
			...
			<div class="panel-body">
				<form action="" method="POST" class="form-horizontal allcp-form  form-edit-item" role="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" name="post_id" placeholder=""
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<textarea type="text" class="form-control" name="content" placeholder=""
					...
					<div class="form-group">
						<label class="col-sm-3 control-label">Social Item</label>
						<div class="col-sm-9">
							<label class="field select">
