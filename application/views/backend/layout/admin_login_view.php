...
<head>
    ...
    <meta name="description" content="Ứng dụng công nghệ AI & Big Data vào hệ thống lắng nghe trên mạng xã hội (Social Listening)" />
    <meta name="keywords" content="Metronic, bootstrap, bootstrap 5, Angular, VueJs, React, Laravel, admin themes, web design, figma, web development, free templates, free admin themes, bootstrap theme, bootstrap template, bootstrap dashboard, bootstrap dak mode, bootstrap button, bootstrap datepicker, bootstrap timepicker, fullcalendar, datatables, flaticon" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta charset="utf-8" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="Socialheat - Hệ thống lắng nghe trên mạng xã hội" />
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable" style="background-image: url('/assets/images/bglogin.png');background-repeat: no-repeat;background-position: center;background-size: cover;height: auto">
    <!--begin::Main-->
                    ...
                    <div class="card card-flush w-md-400px w-lg-400px w-xl-400px w-325px py-5">
                        <div class="card-body">
                            ...
                            <div class="text-center text-gray-400 fw-bold fs-4">Don’t have an account?
                                <a href="/sigup" class="btn fw-bolder link-primary ml-2" style="color:#2B00FF;">Register</a>
                            </div>
                        </div>
                    </div>
                    <!--end::Wrapper-->
