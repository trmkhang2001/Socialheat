					...
					<div class="d-flex justify-content-center align-items-center row">
						<div class="col">
							...
							<div class="card p-5 mt-5">
								...
								<div class="fw-bold fs-2 mt-3"><?php echo number_format($content['email_count'] ?? 0) ?></div>
							</div>
						</div>
						<div class="col">
							<div class="card p-5">
								...
								<div class="fw-bold fs-2 mt-3"><?php echo number_format($content['relationship_count'] ?? 0) ?></div>
							</div>
							<div class="card p-5 mt-5">
								...
								<div class="m-portlet__head mb-10">
									<div class="m-portlet__head-tools d-flex justify-content-end">
										<?php if (in_array($userInfo['role_id'], [ROLE_ADMIN, ROLE_DOWNLOAD], FALSE)) : ?>
											...
											<a href="/backend/monitoring/downloads/<?= $content['id'] ?>"
											   class="btn btn-secondary m-btn m-btn--custom m-btn--icon m-btn--air btn-export group-export-csv can-export">
                                                <span>
																			...
																			<tr>
																				<td>
																					<div class="d-flex align-items-center symbol symbol-50px">
																						<a href="https://facebook.com/<?= $interaction['uid'] ?>"
																						   class="symbol symbol-50px me-4"
																						   target="_blank">
																							<img style="width: 40px; height:40px"
																							     class="border rounded-pill m--img-rounded m--marginless"
																							     src="https://graph.facebook.com/<?= $interaction['uid'] ?>/picture?type=large&width=500&height=500&access_token=2712477385668128|b429aeb53369951d411e1cae8e810640"
																							     alt="">
																						</a>
																						<a target="_blank"
																						   href="https://facebook.com/<?= $interaction['uid'] ?>"
																						   class="text-gray-800 text-hover-primary fs-5 fw-bold"
																						   data-kt-ecommerce-product-filter="product_name"><?= $interaction['name'] ?></a>

																					</div>
																				</td>
																				<td>
																					<?php if ( ! empty($interaction['email'])) { ?>
																						<span class="fw-bold badge badge-blue px-4 showData"
																						      data-decode="<?= $interaction['email'] ?>">
                                                                                                <span class="svg-icon svg-icon-5 svg-icon-success ms-n1 me-1"
                                                                                                      style="color: #5c98ff;">
                                                                                                    <i class="fa-solid fa-eye fa-beat me-2"
                                                                                                       style="color: #5c98ff;"></i>Show
                                                                                                </span>
                                                                                            </span>
																					<?php } ?>
																				</td>
																						...
																						<span class="badge badge-blue px-4">
                                                                                                ...
                                                                                                <span class="svg-icon svg-icon-5 svg-icon-success ms-n1 me-1">
                                                                                                    <svg width="12"
                                                                                                        ...
                                                                                                        <path d="M10.4879 3.76222V1.51221H8.23785"
                                                                                                              stroke="#2F81FC"
                                                                                                              stroke-width="1.4"
                                                                                                              stroke-linecap="round"
                                                                                                              stroke-linejoin="round"></path>
                                                                                                        <path d="M2.60325 9.50028C3.97007 10.8671 6.18617 10.8671 7.553 9.50028C8.23642 8.81685 8.57812 7.92113 8.57812 7.0254C8.57812 6.12968 8.23642 5.23395 7.553 4.55053C6.18617 3.18368 3.97007 3.18368 2.60325 4.55053C1.23642 5.91735 1.23642 8.13343 2.60325 9.50028Z"
                                                                                                              stroke="#2F81FC"
                                                                                                              stroke-width="1.4"
                                                                                                              stroke-linejoin="round"></path>
                                                                                                        <path d="M7.49997 4.50008L9.98787 2.01221"
                                                                                                              stroke="#2F81FC"
                                                                                                              stroke-width="1.4"
                                                                                                              stroke-linecap="round"
                                                                                                              stroke-linejoin="round"></path>
                                                                                                    ...
                                                                                                    <svg width="12"
                                                                                                        ...
                                                                                                        <g clip-path="url(#clip0_575_111)">
                                                                                                            <path d="M12 0H0V12H12V0Z"
                                                                                                                  fill="white"
                                                                                                                  fill-opacity="0.01"></path>
                                                                                                            <path d="M9.59467 2.46307C8.22784 1.09624 6.01176 1.09624 4.64492 2.46307C3.96151 3.14649 3.6198 4.04222 3.6198 4.93795C3.6198 5.83368 3.96151 6.7294 4.64492 7.41282C6.01176 8.77966 8.22784 8.77966 9.59467 7.41282C10.9615 6.04599 10.9615 3.82991 9.59467 2.46307Z"
                                                                                                                  stroke="#F87B7B"
                                                                                                                  stroke-width="1.4"
                                                                                                                  stroke-linejoin="round"></path>
                                                                                                            <path d="M4.61612 7.38394L1.43414 10.5659"
                                                                                                                  stroke="#F87B7B"
                                                                                                                  stroke-width="1.4"
                                                                                                                  stroke-linecap="round"
                                                                                                                  stroke-linejoin="round"></path>
                                                                                                            <path d="M4.79289 10.3892L1.61091 7.20718"
                                                                                                                  stroke="#F87B7B"
                                                                                                                  stroke-width="1.4"
                                                                                                                  stroke-linecap="round"
                                                                                                                  stroke-linejoin="round"></path>
