                ...
                <div class="card-body pt-9 pb-2 s-2">
                    <form action="">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="groupkeys" placeholder="Group Keyword Name">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="text" class="col-sm-2 col-form-label">Description</label>
                            <div class="col-sm-10">
                                <input type="text" style="height: 150px;" class="form-control" id="description">
                            </div>
                        </div>
                        <div class="mb-3 row d-flex">
                            <div class="d-flex justify-content-end align-items-center gap-2 gap-lg-3">
                                ...
                                <a href="" class="btn btn-sm fw-bold btn-primary"> Add Group</a>
                            </div>
                        </div>
                    </form>
                </div>
