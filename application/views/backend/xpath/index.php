			...
			<div class="">
				<form method="get" action="">
					<div class="form-inline">
						...
						<div class="form-group col-md-2">
							<label class="text-system">Type</label>
							<div class="form-inline">
								...
								<td class="actions">
									<ul class="list-inline">
										<li><a data-toggle="tooltip" data-title="Updated"
											   href="/backend/xpath/update/<?php echo $item->id ?>?type_xpath=<?= $type ?>"
											   class="btn btn-primary"><i class="fa fa-edit"></i></a></li>
										<li><a data-toggle="tooltip" data-title="Deleted"
											   href="/backend/xpath/delete/<?php echo $item->id ?>"
											   class="btn btn-delete btn-danger"><i class="fa fa-trash-o"></i></a></li>
										<li><a data-toggle="tooltip" data-title="Copy api token " href="#"
											   data-url="<?= $urlApi ?>" class="btn btn-alert copy-api-url"
											   data-original-title=""
											   title=""><i class="fa fa-copy "></i></a></li>
