...
(function(c) {
  c.extend(c.fn, {
    validate: function(a) {
      ...
      d = c.validator.normalizeRules(
          c.extend({}, c.validator.metadataRules(d), c.validator.classRules(d), c.validator.attributeRules(d),
              c.validator.staticRules(d)), d);
      if (d.required) {
        e = d.required;
        delete d.required;
  ...
  c.extend(c.validator, {
    defaults: {
      ...
      onclick: function(a) {
        if (a.name in this.submitted) this.element(a); else a.parentNode.name in this.submitted &&
    ...
    prototype: {
      init: function() {
        ...
        c(this.currentForm).
            ...
            validateDelegate('[type=\'radio\'], [type=\'checkbox\'], select, option', 'click',
                a);
      ...
      prepareElement: function(a) {
        ...
        for (var a = 0; a < arguments.length; a++) if (arguments[a] !== undefined) return arguments[a];
          ...
          a,
          b) {
        return this.findDefined(this.customMessage(a.name, b), this.customMetaMessage(a, b),
        ...
        if (typeof d == 'function') d = d.call(this, b.parameters, a); else if (e.test(d)) d = jQuery.format(
            d.replace(e, '{$1}'), b.parameters);
        ...
        if (this.settings.unhighlight) {
          a = 0;
          for (b = this.validElements(); b[a]; a++) this.settings.unhighlight.call(this, b[a], this.settings.errorClass,
        ...
        if (d.length) {
          ...
          (this.settings.errorPlacement ? this.settings.errorPlacement(d, c(a)) : d.insertAfter(a));
        }
        ...
        return c(document.getElementsByName(a)).map(function(
            d,
            e) {
        ...
        return c.data(a, 'previousValue') ||
            c.data(a, 'previousValue', {old: null, valid: true, message: this.defaultMessage(a, 'remote')});
      },
    },
    classRuleSettings: {
    ...
    attributeRules: function(a) {
      ...
      for (var d in c.validator.methods) {
        var e;
        if (e = d === 'required' && typeof c.fn.prop === 'function' ?
            a.prop(d) :
            a.attr(d)) b[d] = e; else if (a[0].getAttribute('type') === d) b[d] = true;
      }
...
(function(c) {
  !jQuery.event.special.focusin && !jQuery.event.special.focusout && document.addEventListener &&
