  ...
  var runDemoSourceCode = function() {
    ...
    if (bsElement.length) {
      ...
      $("<link/>", {
        rel: "stylesheet",
        type: "text/css",
        href: window.location.protocol + '//' + window.location.hostname + ':92/assets/backend/js/plugins/highlight/styles/github.css'
      }).appendTo("head");

      $.getScript(window.location.protocol + '//' + window.location.hostname + ':92/assets/backend/js/plugins/highlight/highlight.pack.js');
